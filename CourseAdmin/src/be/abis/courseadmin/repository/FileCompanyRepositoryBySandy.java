...
public class FileCompanyRepositoryBySandy implements CompanyRepository {

    private List<Company> companies;
    String pathToFile = "c:\\temp\\javacourses\\companies.txt";

    public FileCompanyRepositoryBySandy() {
    ...
    public void addCompany(Company c) throws CompanyAlreadyExistsException {
        boolean b=false;
        this.readFile();
        String compToAdd = c.getCompanyName();
    ...
    public void updateCompany(Company c) throws CompanyNotFoundException {
        ...
        foundCompany.setCompanyName(c.getCompanyName());
        try {
